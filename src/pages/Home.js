  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        root: {
          ...
          color: "#000", // black text on green background buttons
          backgroundColor: "#AEEA00", // lime green base button color
          "&:hover": {
            backgroundColor: "#00f721", // bright green hover
            color: "#000000",
          },
        },
      },
    ...
    MuiMenuItem: {
      styleOverrides: {
        root: {
          "&:hover": {
            backgroundColor: "#009b5929", // translucent dark green hover
          },
        },
      },
    },
    ...
    >
      ...
      {drawerPage === "main" && (
        <>
          ...
          {/* Menu List */}
          <List sx={{ mx: 2, my: 2, gap: 2, display: "flex", flexDirection: "column" }}>
            <ListItem sx={{ backgroundColor: "#2c2c2ca6", borderRadius: 1.6, px: 0 }}>
            ...
            <ListItem sx={{ backgroundColor: "#ff000046", borderRadius: 1.6, px: 0 }}>
              <ListItemButton onClick={() => setConfirmLogout(true)}>
                <ListItemIcon>
