...
import { collection, getDocs, query, orderBy, limit, onSnapshot, doc, updateDoc, addDoc } from "firebase/firestore";
...
function Chats() {
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      {/* Group Form */}
      {showGroupForm && (
        <form onSubmit={handleGroupSubmit} style={{ marginBottom: "30px", padding: "15px", background: "#eee", borderRadius: "10px" }}>
          <input
            type="text"
